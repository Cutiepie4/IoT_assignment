                                ...
                                <div className="row justify-content-center">
                                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <form className="mx-1 mx-md-4">
                                            ...
                                            <div className='d-flex align-items-center justify-content-center mb-3'>Not a member?<a href="/sign-up" className='ms-2'>Sign up here.</a></div>
                                            <div className='d-flex align-items-center justify-content-center'><a href="/" className='ms-2'>To home page.</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
