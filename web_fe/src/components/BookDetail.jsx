            ...
            <div className='container card col-md-12 col-lg-10' style={{ backgroundColor: '#faf9ba' }}>
                <div className="container px-4 px-lg-5 my-5 ">
                    <div className="row gx-4 gx-lg-5 align-items-center">
                        <div className="col-md-4 align-self-start" ><img className="card-img-top mb-5 mb-md-0" src={order.book.imagePath && `/images/${order.book.imagePath}`} alt="book-cover" /></div>
                        <div className="col-md-8">
                            <h1 className="display-6 mb-3 fw-bolder" style={{ margin: '0 0' }}>{order.book.title}</h1>
                            ...
                            <div className="fs-4 mb-3">
                                ...
                                <span style={{ color: 'red' }}>{order.book.price && order.book.price.toLocaleString() + ' vnđ'} </span>
                            </div>
